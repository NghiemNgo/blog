        ...
        <div id="page-container">
            ...
            <div class="row">
                <div class="panel-body">
                    <form id="form top-page" class="form-horizontal" role="form" method="post" action="{{ url()->route('home.create') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('small_title') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-8">
                                <input id="top_page_small_title" type="text" class="form-control" name="small_title" value="{{ old('top_page_small_title') }}">
                                @if ($errors->has('top_page_small_title'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('top_page_small_title') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
                        <div class="form-group{{ $errors->has('top_page_big_title') ? ' has-error' : '' }}">
                            <label for="top_page_big_title" class="col-md-2 control-label">Big Title</label>
                            <div class="col-md-8">
                                <input id="top_page_big_title" type="text" class="form-control" name="big_title" value="{{ old('top_page_big_title') }}">
                                @if ($errors->has('top_page_big_title'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('top_page_big_title') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
                        <div class="form-group{{ $errors->has('top_page_content') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-8">
                                ...
                                @if ($errors->has('top_page_content'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('top_page_content') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
                        <div class="form-group{{ $errors->has('top_page_slogan') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-8">
                                ...
                                @if ($errors->has('top_page_slogan'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('top_page_slogan') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="panel-body">
                    <form id="form products-page" class="form-horizontal" role="form" method="post" action="{{ url()->route('home.create') }}">
                        {{ csrf_field() }}
                        <input type="hidden" id="homeCategory" name="homeCategory" value="products-page"/>
                        <div class="form-group{{ $errors->has('products_page_small_title') ? ' has-error' : '' }}">
                            <label for="products_page_small_title" class="col-md-2 control-label">Small Title</label>
                            <div class="col-md-8">
                                <input id="products_page_small_title" type="text" class="form-control" name="small_title" value="{{ old('products_page_small_title') }}">
                                @if ($errors->has('products_page_small_title'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('products_page_small_title') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
                        <div class="form-group{{ $errors->has('products_page_big_title') ? ' has-error' : '' }}">
                            <label for="products_page_big_title" class="col-md-2 control-label">Big Title</label>
                            <div class="col-md-8">
                                <input id="products_page_big_title" type="text" class="form-control" name="big_title" value="{{ old('products_page_big_title') }}">
                                @if ($errors->has('products_page_big_title'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('products_page_big_title') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
                        <div class="form-group{{ $errors->has('products_page_content') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-8">
                                ...
                                @if ($errors->has('products_page_content'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('products_page_content') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="form-group{{ $errors->has('products_page_content1') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-8">
                                ...
                                @if ($errors->has('products_page_content1'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('products_page_content1') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="form-group{{ $errors->has('products_page_content2') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-8">
                                ...
                                @if ($errors->has('products_page_content2'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('products_page_content2') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="form-group{{ $errors->has('products_page_content3') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-8">
                                ...
                                @if ($errors->has('products_page_content3'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('products_page_content3') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="form-group{{ $errors->has('products_page_content4') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-8">
                                ...
                                @if ($errors->has('products_page_content4'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('products_page_content4') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="panel-body">
                    <form id="form news-page" class="form-horizontal" role="form" method="post" enctype="multipart/form-data" action="{{ url()->route('home.create') }}">
                        {{ csrf_field() }}
                        <input type="hidden" id="homeCategory" name="homeCategory" value="news-page"/>
                        <div class="form-group{{ $errors->has('news_page_small_title') ? ' has-error' : '' }}">
                            <label for="news_page_small_title" class="col-md-2 control-label">Small Title</label>
                            <div class="col-md-8">
                                <input id="news_page_small_title" type="text" class="form-control" name="small_title" value="{{ old('news_page_small_title') }}">
                                @if ($errors->has('news_page_small_title'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('news_page_small_title') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
                        <div class="form-group{{ $errors->has('news_page_big_title') ? ' has-error' : '' }}">
                            <label for="news_page_big_title" class="col-md-2 control-label">Big Title</label>
                            <div class="col-md-8">
                                <input id="news_page_big_title" type="text" class="form-control" name="big_title" value="{{ old('news_page_big_title') }}">
                                @if ($errors->has('news_page_big_title'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('news_page_big_title') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
                        <div class="form-group{{ $errors->has('news_page_title1') ? ' has-error' : '' }}">
                            <label for="news_page_title1" class="col-md-2 control-label">Title 1</label>
                            <div class="col-md-8">
                                <input id="news_page_title1" type="text" class="form-control" name="small_content_title[]" value="{{ old('news_page_title1') }}">
                                @if ($errors->has('news_page_title1'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('news_page_title1') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
                        <div class="form-group{{ $errors->has('news_page_content1') ? ' has-error' : '' }}">
                        ...
                        <div class="form-group{{ $errors->has('news_page_title2') ? ' has-error' : '' }}">
                            <label for="news_page_title2" class="col-md-2 control-label">Title 2</label>
                            <div class="col-md-8">
                                <input id="news_page_title2" type="text" class="form-control" name="small_content_title[]" value="{{ old('news_page_title2') }}">
                                @if ($errors->has('news_page_title2'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('news_page_title2') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
                        <div class="form-group{{ $errors->has('news_page_content2') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-8">
                                ...
                                @if ($errors->has('news_page_content2'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('news_page_content2') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="form-group{{ $errors->has('news_page_title3') ? ' has-error' : '' }}">
                            <label for="news_page_title3" class="col-md-2 control-label">Title 3</label>
                            <div class="col-md-8">
                                <input id="news_page_title3" type="text" class="form-control" name="small_content_title[]" value="{{ old('news_page_title3') }}">
                                @if ($errors->has('news_page_title3'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('news_page_title3') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
                        <div class="form-group{{ $errors->has('news_page_content3') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-8">
                                ...
                                @if ($errors->has('news_page_content3'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('news_page_content3') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="form-group{{ $errors->has('news_page_title4') ? ' has-error' : '' }}">
                            <label for="news_page_title4" class="col-md-2 control-label">Title 4</label>
                            <div class="col-md-8">
                                <input id="news_page_title4" type="text" class="form-control" name="small_content_title[]" value="{{ old('news_page_title4') }}">
                                @if ($errors->has('news_page_title4'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('news_page_title4') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
                        <div class="form-group{{ $errors->has('news_page_content4') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-8">
                                ...
                                @if ($errors->has('news_page_content4'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('news_page_content4') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="panel-body">
                    <form id="form about-us" class="form-horizontal" role="form" method="post" action="{{ url()->route('home.create') }}">
                        {{ csrf_field() }}
                        <input type="hidden" id="homeCategory" name="homeCategory" value="about-us"/>
                        <div class="form-group{{ $errors->has('about_us_small_title') ? ' has-error' : '' }}">
                            <label for="about_us_small_title" class="col-md-2 control-label">Small Title</label>
                            <div class="col-md-8">
                                <input id="about_us_small_title" type="text" class="form-control" name="small_title" value="{{ old('about_us_small_title') }}">
                                @if ($errors->has('about_us_small_title'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('about_us_small_title') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
                        <div class="form-group{{ $errors->has('about_us_big_title') ? ' has-error' : '' }}">
                            <label for="about_us_big_title" class="col-md-2 control-label">Big Title</label>
                            <div class="col-md-8">
                                <input id="about_us_big_title" type="text" class="form-control" name="big_title" value="{{ old('about_us_big_title') }}">
                                @if ($errors->has('about_us_big_title'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('about_us_big_title') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="panel-body">
                    <form id="form recruit-us" class="form-horizontal" role="form" method="post" action="{{ url()->route('home.create') }}">
                        {{ csrf_field() }}
                        <input type="hidden" id="homeCategory" name="homeCategory" value="recruit"/>
                        <div class="form-group{{ $errors->has('recruit_small_title') ? ' has-error' : '' }}">
                            <label for="recruit_small_title" class="col-md-2 control-label">Small Title</label>
                            <div class="col-md-8">
                                <input id="recruit_small_title" type="text" class="form-control" name="small_title" value="{{ old('recruit_small_title') }}">
                                @if ($errors->has('recruit_small_title'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('recruit_small_title') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
                        <div class="form-group{{ $errors->has('recruit_content') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-8">
                                ...
                                @if ($errors->has('recruit_content'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('recruit_content') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="panel-body">
                    <form id="form workplade" class="form-horizontal" role="form" method="post" enctype="multipart/form-data" action="{{ url()->route('home.create') }}">
                        {{ csrf_field() }}
                        <input type="hidden" id="homeCategory" name="homeCategory" value="workplace"/>
                        <div class="form-group{{ $errors->has('workplace_small_title') ? ' has-error' : '' }}">
                            <label for="workplace_small_title" class="col-md-2 control-label">Small Title</label>
                            <div class="col-md-8">
                                <input id="workplace_small_title" type="text" class="form-control" name="small_title" value="{{ old('workplace_small_title') }}">
                                @if ($errors->has('workplace_small_title'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('workplace_small_title') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="panel-body">
                    <form id="form customer" class="form-horizontal" role="form" method="post" enctype="multipart/form-data" action="{{ url()->route('home.create') }}">
                        {{ csrf_field() }}
                        <input type="hidden" id="homeCategory" name="homeCategory" value="customer"/>
                        <div class="form-group{{ $errors->has('customer_small_title') ? ' has-error' : '' }}">
                            <label for="customer_small_title" class="col-md-2 control-label">Small Title</label>
                            <div class="col-md-8">
                                <input id="customer_small_title" type="text" class="form-control" name="small_title" value="{{ old('customer_small_title') }}">
                                @if ($errors->has('customer_small_title'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('customer_small_title') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
