        ...
        <div class="col-md-10 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">-->
                    <!--<form class="form-horizontal" role="form" method="post" action="<?php echo e(url()->route('home.items')); ?>">-->
...
<!--                        <div class="form-group<?php echo e($errors->has('content') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-8">
                                 <textarea id="content" class="form-control" rows="5" cols="90" name="content"><?php echo e($homeContent->content); ?></textarea>
